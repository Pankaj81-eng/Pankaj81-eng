...
| Project | Domain | Code |
|---|---|---|
| **RootSeekers - Incident RCA Copilot**<br/><sub>LangGraph multi-agent RCA for Google Cloud incidents, built for a Google Cloud hackathon</sub> | Agentic AI | 🔓 [Repo](https://github.com/Pankaj81-eng/Hackathon2026_RootSeekers) · 🎥 [Demo](https://youtu.be/2NhyX1LoOBc) |
